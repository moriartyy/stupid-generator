package stupid.generator.util.test;

import stupid.generator.Generator;
import stupid.generator.GeneratorFacade;
import stupid.generator.provider.db.sql.model.Sql;
import stupid.generator.util.FileHelper;
...
public class GeneratorTestHelper {
	...
	public static String generateBy(GeneratorFacade gf,
									Generator.GeneratorModel... models) throws Exception {
