package stupid.generator.provider.db.sql;

import stupid.generator.provider.db.DataSourceProvider;
import stupid.generator.provider.db.sql.model.Sql;
import stupid.generator.provider.db.sql.model.SqlParameter;
import stupid.generator.provider.db.table.TableFactory;
import stupid.generator.provider.db.table.model.Column;
import stupid.generator.provider.db.table.model.Table;
import stupid.generator.util.BeanHelper;
import stupid.generator.util.DBHelper;
import stupid.generator.util.GLogger;
import stupid.generator.util.StringHelper;
import stupid.generator.util.sqlerrorcode.SQLErrorCodeSQLExceptionTranslator;
import stupid.generator.util.sqlparse.*;
import stupid.generator.util.typemapping.JdbcType;
