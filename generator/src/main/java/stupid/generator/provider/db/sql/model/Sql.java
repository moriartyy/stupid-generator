package stupid.generator.provider.db.sql.model;

import stupid.generator.GeneratorConstants;
import stupid.generator.GeneratorProperties;
import stupid.generator.provider.db.sql.SqlFactory;
import stupid.generator.provider.db.table.model.Column;
import stupid.generator.provider.db.table.model.ColumnSet;
import stupid.generator.provider.db.table.model.Table;
import stupid.generator.util.StringHelper;
import stupid.generator.util.sqlparse.SqlParseHelper;
import stupid.generator.util.sqlparse.SqlTypeChecker;
import stupid.generator.util.typemapping.JavaPrimitiveTypeMapping;
...
public class Sql {
    ...
    public boolean isColumnsInSameTable() {
        ...
        Collection<SqlParseHelper.NameWithAlias> tableNames = SqlParseHelper.getTableNamesByQuery(executeSql);
